...
- [ ] T0020 Decide whether build.gradle and docs/multi-module.md should configure 'withJavadocJar()' and 'withSourcesJar()' in the java block: all three real projects configure both across all subprojects, but the template does not. **[Decided]**: Yes
