...
- [~] A0017 [owner: @claude] Add scaffolded `scripts/bootstrap-dev-environment.py` (replacing setup.ps1) and `scripts/deploy-to-production.py` per dev-guidelines' scripts-directory convention.
