...
- [~] A0005 [owner: @claude] Add a Spotless formatting/lint gate to build.gradle by default: only hinolugi-support.java wires up 'com.diffplug.spotless' with 'check' depending on 'spotlessCheck'; neither the template nor hinolugi-auth run any formatting or static analysis, despite the guideline requiring it in CI.
